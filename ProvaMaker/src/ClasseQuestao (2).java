...
public class ClasseQuestao {
	...
	private ClasseResposta[] resposta;
	private boolean escolhaMultipla;
	...
	public ClasseQuestao (String txt, boolean mult){
		escolhaMultipla = mult;
		pergunta = txt;
		resposta = new ClasseResposta[8];
		resposta[0] = null; // Talvez erro aqui...... fique esperto
	}
