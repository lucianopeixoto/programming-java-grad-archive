...
public class ClasseProva {
	private String nomeProva;			// Título da prova
	private String nomeAluno;			// Nome do aluno
	private String nomeProfessor;		// Nome do professor
	private ClasseQuestao[] questao;	// Vetor de questões
	private int pontuacao;				// A pontuação feita naquela prova (O criador de prova não precisa usar)
	...
	public void setNomeProva (String txt){
		nomeProva = txt;
	}
	...
	public void dltQuestao(){
		int n=0;
		while (questao[n+1] != null){
			n++;
		}
		questao[n] = null;
	}
	public void dltQuestao(int qId){
		while (questao[qId] != null){
			questao[qId] = questao[qId + 1];
			qId ++;
		}
	}
}